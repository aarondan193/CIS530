...
IF OBJECT_ID('dbo.DEPENDANT') IS NULL
...
ADD PRIMARY KEY (ESSN, DEPENDANT_NAME);
...
INSERT INTO COMPANY.dbo.DEPENDANT values('123456789','Alice','F','31-Dec-78','Daughter'),
